document.addEventListener('DOMContentLoaded', function () {
  ...
  function applyStaggeredDelays() {
    ...
    staggerGroups.forEach(function (group) {
      const interval = parseInt(group.getAttribute('data-stagger'), 10) || 100;
      const children = group.children;
      Array.from(children).forEach(function (child, index) {
        if (!child.hasAttribute('data-delay')) {
          child.setAttribute('data-delay', index * interval);
        }
      });
    });
  }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "עו\"ד יצחק גואטה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: 'dc82ff02-4b75-4c0b-876d-8319b4fad662',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || 'dc82ff02-4b75-4c0b-876d-8319b4fad662';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'dc82ff02-4b75-4c0b-876d-8319b4fad662';
